...
## 9. Prompt Cho AI (Cursor / ChatGPT)

Copy prompt sau để khởi tạo nhanh từng module:

```
Hãy tạo cấu trúc module [Tên_Màn_Hình] sử dụng Flutter với GetX theo kiến trúc MVVM.

- Model: Định nghĩa class dữ liệu dựa trên [Mô tả dữ liệu].
- Controller: Xử lý logic, dùng Repository để lấy dữ liệu từ [Service].
- View: Thiết kế UI theo tiêu chuẩn:
    - Nền app: #F5F7FB | Card: #FFFFFF với shadow nhẹ, border-radius: 12
    - FAB và Header dùng AppColors.primaryBlue (#2F80ED)
    - Progress Bar: AppColors.successGreen nếu hoàn thành, AppColors.alertRed nếu quá hạn
    - Tiêu đề màu #0F1724, font-weight: bold, dùng GoogleFonts.inter
- Binding: Cấu hình Dependency Injection cho module này.
```
...
- [ ] Thêm dependencies vào `pubspec.yaml` và chạy `flutter pub get`
- [ ] Tạo `lib/core/values/app_colors.dart`
- [ ] Tạo `lib/core/values/app_text_styles.dart`
- [ ] Tạo `lib/routes/app_routes.dart` và `app_pages.dart`
- [ ] Tạo module đầu tiên: `lib/modules/home/`
- [ ] Cập nhật `main.dart` dùng `GetMaterialApp` với `AppPages.pages`
- [ ] Thống nhất quy ước đặt tên với cả team

---

*Tài liệu này được duy trì bởi team. Mọi thay đổi về kiến trúc cần được thảo luận và cập nhật vào đây.*
